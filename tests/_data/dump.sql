...
--
-- Host: localhost    Database: dev_phpleak
-- ------------------------------------------------------
...
CREATE TABLE `links` (
  ...
  CONSTRAINT `links_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `links_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2015-03-24 14:25:32
